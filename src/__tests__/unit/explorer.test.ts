...
describe("Stellar Explorer Utility", () => {
  ...
  it("proves testnet passphrase produces the testnet URL", () => {
    ...
    expect(explorerAccountUrl("address123")).toBe(
      "https://stellar.expert/explorer/testnet/account/address123",
    );
  });
  ...
  it("proves mainnet passphrase produces the mainnet URL", () => {
    ...
    expect(explorerAccountUrl("address123")).toBe(
      "https://stellar.expert/explorer/public/account/address123",
    );
  });
